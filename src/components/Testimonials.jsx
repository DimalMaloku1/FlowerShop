      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            Read testimonials from our happy customers who have experienced the joy of our floral arrangements.
          </p>
        </div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">{testimonial.occasion}</p>
                </div>
              </div>
